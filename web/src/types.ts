...
export interface Task { id: string; goal_id: string; parent_id?: string; type: string; title: string; description: string; status: string; blocked_reason?: string; priority: number; estimate_minutes: number; success_criteria: string; minimum_action: string; revision: number }
...
export interface NotificationChannel { id: string; name: string; provider: string; endpoint: string; settings: Record<string, string>; secret_hint: string; secret_set: boolean; status: string; last_check_at?: string; last_check_status: string; last_error?: string; target_count: number; active_target_count: number; revision: number; created_at: string; updated_at: string }
export interface NotificationTarget { id: string; user_id: string; user_identifier?: string; user_display_name?: string; channel_id: string; channel_name?: string; provider?: string; label: string; address_hint: string; status: string; failure_count: number; last_error?: string; last_sent_at?: string; revision: number; created_at: string; updated_at: string }
export interface NotificationMessage { id: string; user_id: string; user_identifier?: string; user_display_name?: string; channel_id: string; channel_name?: string; provider?: string; target_id: string; target_hint?: string; topic: string; title: string; body: string; url: string; payload_json: string; status: string; attempts: number; max_attempts: number; provider_message_id?: string; last_error?: string; run_after: string; created_at: string; updated_at: string; sent_at?: string }
export interface NotificationCheck { verified: boolean; provider: string; channel: string; detail?: string; checked_at: string }
export interface NotificationDelivery { delivered: boolean; provider: string; channel: string; provider_message_id?: string; detail?: string; invalid_target?: boolean }
export interface NotificationDispatch { claimed: number; sent: number; retried: number; failed: number; retired: number }
