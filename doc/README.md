...
| [`notification.md`](notification.md) | 🟢 已实现 | 2026-09-24 | 262 | Telegram / Bark / FCM / APNs 四个提供方、通道与接收端的加密存储、队列与退避投递、后台管理界面。§13 是验证记录 |
...
| [`qa-2026-09-24.md`](qa-2026-09-24.md) | 界面复审 / 打磨记录 | 2026-09-24 | 按 `AGENTS.md` 复审渲染结果的可见问题、以删除为主的改动、构建产物渲染断言与部署回滚件 |
